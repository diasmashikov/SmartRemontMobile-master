...
data class RemontListDBModel(
        ...
        @ColumnInfo(name = "stage_status_name") var stageStatusName: String?,
        @ColumnInfo(name = "defect_cnt") var defectCnt: Int,
        @ColumnInfo(name = "defect_accept_cnt") var defectAcceptCnt: Int,
        ...
        @ColumnInfo(name = "constructor_url") var constructorUrl: String? = null,
