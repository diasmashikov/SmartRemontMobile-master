...
class DialogPhotoReportPhotosAdapter(
        private val bitmaps: MutableList<File?>,
        private val imagesPath: MutableList<String?>,
) : RecyclerView.Adapter<DialogPhotoReportPhotosAdapter.Holder>() {
    ...
    override fun onBindViewHolder(holder: Holder, position: Int) {
        ...
        holder.itemView.setOnClickListener {
            photoReportViewListener?.showViewPager(position, bitmaps, imagesPath)
